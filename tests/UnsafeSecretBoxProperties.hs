...
module UnsafeSecretBoxProperties (
  testUnsafeSecretBox
  ) where

import           Util
import           Crypto.Saltine.Unsafe.SecretBox
...
testUnsafeSecretBox :: Test
testUnsafeSecretBox = buildTest $ do

  return $ testGroup "...Unsafe.SecretBox" [
