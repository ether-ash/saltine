-- |
-- Module      : Crypto.Saltine.Unsafe.SecretBox
...
-- "Crypto.Saltine.Unsafe.SecretBox"
--
...
--
-- The "Crypto.Saltine.Unsafe.SecretBox" module is designed to meet
...
--
-- "Crypto.Saltine.Unsafe.SecretBox" is
