...
--
-- The "Crypto.Saltine.Unsafe.Box" module is not meant to provide
...
-- "Crypto.Saltine.Unsafe.Sign" module.
--
-- "Crypto.Saltine.Unsafe.Box" is @curve25519xsalsa20poly1305@, a
